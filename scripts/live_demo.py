...
def main(camera_id=0, filename=None, hrnet_m='HRNet', hrnet_c=48, hrnet_j=17, hrnet_weights="./weights/pose_hrnet_w48_384x288.pth", hrnet_joints_set="coco", image_resolution='(384, 288)',
         ...
         video_format='MJPG', video_framerate=30, device=None, enable_tensorrt=False):
